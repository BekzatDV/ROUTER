...
let products = [
  ...
  },
  {
    ...
    price: "My friend's blog",
    id: 2,
  },
  {
    title: "My dog",
    image: "https://svgsilh.com/svg_v2/1484728.svg",
    price: "My dog's blog",
    id: 3,
  },
  {
    title: "My home",
    image: "https://svgsilh.com/svg/1295883.svg",
    price: "My home room tur",
    id: 4,
  },
  {
    title: "Some blog",
    image: "https://svgsilh.com/svg_v2/3246711.svg",
    price: "Some blog",
    id: 4,
  },
];
  ...
  return (
    <div>
      ...
      <div
        ...
        className="d-flex justify-content-between container mt-5"
      >
        {products.map((item) => (
